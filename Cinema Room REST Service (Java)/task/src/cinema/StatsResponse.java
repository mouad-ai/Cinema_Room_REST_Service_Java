...
public class StatsResponse {
    ...
    public StatsResponse(int current_income, int number_of_available_seats, int number_of_purchased_seats) {
        this.current_income = current_income;
        this.number_of_available_seats = number_of_available_seats;
        this.number_of_purchased_tickets = number_of_purchased_seats;
    }
